...
@interface DLLampControlReadingModeViewController ()<UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIPopoverControllerDelegate>
...
- (void)viewDidLoad
{
  ...
  //self.tag=1;
    ...
    NSString *g = [NSString stringWithFormat:@"%@",[[NSString alloc] initWithFormat:@"%1x",255]];
